...
- `config` - *Optional*. A configuration object for the Glue42 factory function;
...
- `this.glueStore.initError` - returns an initialization error object from the Glue42 factory function or `undefined`;
