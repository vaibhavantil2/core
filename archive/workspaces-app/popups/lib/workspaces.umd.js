    ...
    class Base {
        ...
        removeChild(model, predicate) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                yield child.close();
                if (model instanceof Workspace) {
                    console.log("will get reference 1", model.children);
                    yield model.refreshReference();
                    console.log("allchildren", model.children);
                    return;
                }
                console.log("will get reference", model.children);
                yield this.getMyWorkspace(model).refreshReference();
                console.log("allchildren", model.children);
            });
        }
        ...
        close(model) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                if (modelData.parent instanceof Workspace) {
                    ...
                    console.log("workspace reference refreshed", modelData.parent.children);
                }
                else {
                    yield this.getMyWorkspace(modelData.parent).refreshReference();
                    console.log(" reference refreshed", modelData.parent.children);
                }
            });
        }
